...
const FEATURES: Array<{ title: string; desc: string; icon: React.ReactNode }> = [
  ...
  {
    title: "लाइव न्यूज़वायर एकीकरण",
    desc: "राष्ट्रीय, राज्य और स्थानीय खबरें सीधे फ़ीड से आती हैं — हर संस्करण असल में उस दिन की ताज़ा खबर के साथ छपता है।",
    icon: (
      <>
...
const TICKER_ITEMS = [
  { tag: "राष्ट्रीय", text: "लाइव फ़ीड से हर घंटे ताज़ा खबरें" },
    ...
    <div>
      ...
      <section className="grid lg:grid-cols-[1.05fr_0.95fr] gap-12 items-center pb-10">
        <div>
          ...
          >
            लाइव न्यूज़वायर से खबरें खींचकर, हिंदी और अंग्रेज़ी दोनों में, दर्जनों पेशेवर लेआउट के साथ आपका पूरा अखबार अपने आप तैयार होता है — मुखपृष्ठ से लेकर भीतरी पन्नों तक, आपके अपने मास्टहेड और पहचान के साथ।
          </p>
